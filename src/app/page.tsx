    ...
    <>
      ...
      <div className="w-full max-w-[1240px] mx-auto flex flex-col items-start px-4">
        ...
        <div className="flex flex-col items-start">
          ...
          <div
            className="mt-8 bg-white rounded-[40px] w-[400px] h-[270px] flex flex-col items-start p-[30px] shadow-sm relative"
            style={{ minHeight: 270 }}
          >
            <div
            ...
            {/* Текстовый блок */}
            <div className="font-semibold text-2xl leading-tight text-[#333] mt-6">1C-интеграция</div>
            <div className="font-medium text-lg text-[#333] opacity-80 mt-2">Интеграция бизнес-процессов и автоматизация учёта с помощью 1C.</div>
          </div>
        </div>
        ...
        <div className="flex flex-col items-start">
          ...
          <WidgetCard
            ...
            title="Devops"
            text="Непрерывная интеграция и непрерывная поставка программного обеспечения, автоматизация DevOps, управление релизами, обслуживание и поддержка"
            className="flex flex-col items-start p-[30px] gap-4 w-[400px] h-[270px] rounded-[40px] mt-8"
          />
        </div>
      </main>
      {/* Нижние два виджета */}
